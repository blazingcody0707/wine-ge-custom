...
# start build
docker exec buildbot bash -c wget https://raw.githubusercontent.com/olegos2/mobox/refs/heads/main/patches/ge-8-25.patch https://raw.githubusercontent.com/olegos2/mobox/refs/heads/main/patches/fix-address-space.diff
docker exec buildbot bash -c patch -p 1 -i ../ge-8-25.patch && patch -p 1 -i ../fix-address-space.diff
